...
*/
    ...
    {
        if (i % 10 == 9)
        {    /* This is used so that only legal squares are considered */
            i++;
            continue;
        }
        else
...
*/            switch (Board[i])
            {    /* Adding up to see which side has more pieces, both in terms of quantity and quality of those pieces */
                case -5: /* Black Queen */
                    score -= 18;
                    break;
                case -4: /* Black Rook */
